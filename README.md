...
| Sovereignty | 1 | Require that all code is written in, stored in, or otherwise served from a location and/or sovereignty that aligns with orgs requirements | <span style="color: green">Medium</span> | <ul><li>ISM GCSR SC-1572-R1</li><li>ISO27001 A.14.2.7</li></ul> |
